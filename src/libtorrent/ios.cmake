...
set(CMAKE_CXX_FLAGS "-arch armv7 -arch arm64 -Wall -Wextra -Werror")
set(CMAKE_TOOLCHAIN_FILE ios.cmake)

find_package(Boost REQUIRED)
include_directories(${Boost_INCLUDE_DIRS})
include_directories(include/libtorrent-rasterbar-2.0.6/include)
add_library(dart_torrent_ios SHARED src/libtorrent.cpp)

target_link_libraries(dart_torrent_ios PRIVATE ${CMAKE_SOURCE_DIR}/lib/libtorrent-rasterbar-2.0.6-ios-arm64.dylib)
